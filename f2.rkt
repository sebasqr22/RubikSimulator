...
(define (f2d matriz nueva contador type);; se mueve 0, 3, 6
  (cond [(equal? type 3)
         (cond [(equal? contador 0)
                (f2d matriz (cons (list (position matriz 0 0) (position matriz 0 1) (position matriz 0 2)
               ...
               [(equal? contador 1)
                (f2d matriz (cons (list-ref matriz 1) nueva) (+ 1 contador) type)];; naranja
               
               [(equal? contador 2)
                (f2d matriz (cons (list (position matriz 2 0) (position matriz 2 1) (position matriz 2 2)
               ...
               [(equal? contador 3)
                (f2d matriz (cons (list-ref matriz 3) nueva) (+ 1 contador) type)];; rojo
               
               [(equal? contador 4)
                (f2d matriz (cons (list (position matriz 4 0) (position matriz 4 1) (position matriz 4 2)
               ...
               [(equal? contador 5)
                (f2d matriz (cons (list (position matriz 5 0) (position matriz 5 1) (position matriz 5 2)
        ...
        [(equal? type 2)
         (cond [(equal? contador 0)
                (f2d matriz (cons (list (position matriz 0 0) (position matriz 0 1)
                                        (position matriz 5 2) (position matriz 5 3))
                                  nueva) (+ 1 contador) type)] ;;blanco
               [(equal? contador 1)
                (f2d matriz (cons (list (position matriz 1 2) (position matriz 1 0)
                                        (position matriz 1 3) (position matriz 1 1))
                                  nueva) (+ 1 contador) type)] ;;naranja
               
               [(equal? contador 2)
                (f2d matriz (cons (list (position matriz 2 0) (position matriz 2 1)
                                        (position matriz 4 2) (position matriz 4 3))
                                  nueva) (+ 1 contador) type)] ;amarillo
               [(equal? contador 3)
                (f2d matriz (cons (list-ref matriz 3) nueva) (+ 1 contador) type)] ;;roja
               
               [(equal? contador 4)
                (f2d matriz (cons (list (position matriz 4 0) (position matriz 4 1)
                                        (position matriz 0 2) (position matriz 0 3))
                                  nueva) (+ 1 contador) type)] ;;verde
               
               [(equal? contador 5)
                (f2d matriz (cons (list (position matriz 5 0) (position matriz 5 1)
        ...
        [(equal? type 4)
         (cond [(equal? contador 0)
                (f2d matriz (cons (list (position matriz 0 0) (position matriz 0 1) (position matriz 0 2) (position matriz 0 3)
               ...
               [(equal? contador 2)
                (f2d matriz (cons (list (position matriz 2 0) (position matriz 2 1) (position matriz 2 2) (position matriz 2 3)
               ...
               [(equal? contador 4)
                (f2d matriz (cons (list (position matriz 4 0) (position matriz 4 1) (position matriz 4 2) (position matriz 4 3)
               ...
               [(equal? contador 5)    
                (f2d matriz (cons (list (position matriz 5 0) (position matriz 5 1) (position matriz 5 2) (position matriz 5 3)
        ...
        [(equal? type 5)
         (cond [(equal? contador 0)
                (f2d matriz (cons (list (position matriz 0 0) (position matriz 0 1) (position matriz 0 2) (position matriz 0 3) (position matriz 0 4)
               ...
               [(equal? contador 2)
                (f2d matriz (cons (list (position matriz 2 0) (position matriz 2 1) (position matriz 2 2) (position matriz 2 3) (position matriz 2 4)
               ...
               [(equal? contador 4)
                (f2d matriz (cons (list (position matriz 4 0) (position matriz 4 1) (position matriz 4 2) (position matriz 4 3) (position matriz 4 4)
               ...
               [(equal? contador 5)
                (f2d matriz (cons (list (position matriz 5 0) (position matriz 5 1) (position matriz 5 2) (position matriz 5 3) (position matriz 5 4)
...
(define (f2i matriz nueva contador type);; se mueve 0, 3, 6
  (cond [(equal? type 3)
         (cond [(equal? contador 0)
                (f2i matriz (cons (list (position matriz 0 0) (position matriz 0 1) (position matriz 0 2)
                                        (position matriz 4 3) (position matriz 4 4) (position matriz 4 5)
                                        (position matriz 0 6) (position matriz 0 7) (position matriz 0 8))
                                  nueva) (+ 1 contador) type)] ;; blanca
               [(equal? contador 1)
                (f2i matriz (cons (list-ref matriz 1) nueva) (+ 1 contador) type)];; naranja
               
               [(equal? contador 2)
                (f2i matriz (cons (list (position matriz 2 0) (position matriz 2 1) (position matriz 2 2)
                                        (position matriz 5 3) (position matriz 5 4) (position matriz 5 5)
                                        (position matriz 2 6) (position matriz 2 7) (position matriz 2 8))
                                  nueva) (+ 1 contador) type)];; amarillo
               [(equal? contador 3)
                (f2i matriz (cons (list-ref matriz 3) nueva) (+ 1 contador) type)];; rojo
               
               [(equal? contador 4)
                (f2i matriz (cons (list (position matriz 4 0) (position matriz 4 1) (position matriz 4 2)
                                        (position matriz 2 3) (position matriz 2 4) (position matriz 2 5)
                                        (position matriz 4 6) (position matriz 4 7) (position matriz 4 8))
                                  nueva) (+ 1 contador) type)];; verde
               [(equal? contador 5)
                (f2i matriz (cons (list (position matriz 5 0) (position matriz 5 1) (position matriz 5 2)
                                        (position matriz 0 3) (position matriz 0 4) (position matriz 0 5)
                                        (position matriz 5 6) (position matriz 5 7) (position matriz 5 8))
                                  nueva) (+ 1 contador) type)];;azul
               [else (reverse nueva)])]
        ...
        [(equal? type 2)
         (cond [(equal? contador 0)
                (f2i matriz (cons (list (position matriz 0 0) (position matriz 0 1)
                                        (position matriz 4 2) (position matriz 4 3))
                                  nueva) (+ 1 contador) type)] ;;blanco
               [(equal? contador 1)
                (f2i matriz (cons (list-ref matriz 1) nueva) (+ 1 contador) type)] ;;naranja
               ...
               [(equal? contador 2)
                (f2i matriz (cons (list (position matriz 2 0) (position matriz 2 1)
                                        (position matriz 5 2) (position matriz 5 3))
                                  nueva) (+ 1 contador) type)] ;amarillo
               [(equal? contador 3)
                (f2i matriz (cons (list-ref matriz 3) nueva) (+ 1 contador) type)] ;;roja
               
               [(equal? contador 4)
                (f2i matriz (cons (list (position matriz 4 0) (position matriz 4 1)
                                        (position matriz 2 2) (position matriz 2 3))
                                  nueva) (+ 1 contador) type)] ;;verde
               
               [(equal? contador 5)
                (f2i matriz (cons (list (position matriz 5 0) (position matriz 5 1)
                                        (position matriz 0 2) (position matriz 0 3))
                                  nueva) (+ 1 contador) type)] ;;azul
               [else (reverse nueva)])]
        ...
        [(equal? type 4)
         (cond [(equal? contador 0)
                (f2i matriz (cons (list (position matriz 0 0) (position matriz 0 1) (position matriz 0 2) (position matriz 0 3)
                                        (position matriz 4 4) (position matriz 4 5) (position matriz 4 6) (position matriz 4 7)
                                        (position matriz 0 8) (position matriz 0 9) (position matriz 0 10) (position matriz 0 11)
                                        (position matriz 0 12) (position matriz 0 13) (position matriz 0 14) (position matriz 0 15))
                                  nueva) (+ 1 contador) type)] ;;blanco
               ...
               [(equal? contador 2)
                (f2i matriz (cons (list (position matriz 2 0) (position matriz 2 1) (position matriz 2 2) (position matriz 2 3)
                                        (position matriz 5 4) (position matriz 5 5) (position matriz 5 6) (position matriz 5 7)
                                        (position matriz 2 8) (position matriz 2 9) (position matriz 2 10) (position matriz 2 11)
                                        (position matriz 2 12) (position matriz 2 13) (position matriz 2 14) (position matriz 2 15))
                                  nueva) (+ 1 contador) type)] ;;amarillo
               ...
               [(equal? contador 4)
                (f2i matriz (cons (list (position matriz 4 0) (position matriz 4 1) (position matriz 4 2) (position matriz 4 3)
                                        (position matriz 2 4) (position matriz 2 5) (position matriz 2 6) (position matriz 2 7)
                                        (position matriz 4 8) (position matriz 4 9) (position matriz 4 10) (position matriz 4 11)
                                        (position matriz 4 12) (position matriz 4 13) (position matriz 4 14) (position matriz 4 15))
                                  nueva) (+ 1 contador) type)] ;;verde
               ...
               [(equal? contador 5)    
                (f2i matriz (cons (list (position matriz 5 0) (position matriz 5 1) (position matriz 5 2) (position matriz 5 3)
                                        (position matriz 0 4) (position matriz 0 5) (position matriz 0 6) (position matriz 0 7)
                                        (position matriz 5 8) (position matriz 5 9) (position matriz 5 10) (position matriz 5 11)
                                        (position matriz 5 12) (position matriz 5 13) (position matriz 5 14) (position matriz 5 15))
                                  nueva) (+ 1 contador) type)] ;;azul
        ...
        [(equal? type 5)
         (cond [(equal? contador 0)
                (f2i matriz (cons (list (position matriz 0 0) (position matriz 0 1) (position matriz 0 2) (position matriz 0 3) (position matriz 0 4)
                                        (position matriz 4 5) (position matriz 4 6) (position matriz 4 7) (position matriz 4 8) (position matriz 4 9)
                                        (position matriz 0 10) (position matriz 0 11) (position matriz 0 12) (position matriz 0 13) (position matriz 0 14)
                                        (position matriz 0 15) (position matriz 0 16) (position matriz 0 17)(position matriz 0 18) (position matriz 0 19)
                                        (position matriz 0 20) (position matriz 0 21) (position matriz 0 22) (position matriz 0 23) (position matriz 0 24))
               ...
               [(equal? contador 2)
                (f2i matriz (cons (list (position matriz 2 0) (position matriz 2 1) (position matriz 2 2) (position matriz 2 3) (position matriz 2 4)
                                        (position matriz 5 5) (position matriz 5 6) (position matriz 5 7) (position matriz 5 8) (position matriz 5 9)
                                        (position matriz 2 10) (position matriz 2 11) (position matriz 2 12) (position matriz 2 13) (position matriz 2 14)
                                        (position matriz 2 15) (position matriz 2 16) (position matriz 2 17) (position matriz 2 18) (position matriz 2 19)
                                        (position matriz 2 20) (position matriz 2 21) (position matriz 2 22) (position matriz 2 23) (position matriz 2 24))
               ...
               [(equal? contador 4)
                (f2i matriz (cons (list (position matriz 4 0) (position matriz 4 1) (position matriz 4 2) (position matriz 4 3) (position matriz 4 4)
                                        (position matriz 2 5) (position matriz 2 6) (position matriz 2 7) (position matriz 2 8) (position matriz 2 9)
                                        (position matriz 4 10) (position matriz 4 11) (position matriz 4 12) (position matriz 4 13) (position matriz 4 14)
                                        (position matriz 4 15) (position matriz 4 16) (position matriz 4 17) (position matriz 4 18) (position matriz 4 19)
                                        (position matriz 4 20) (position matriz 4 21) (position matriz 4 22) (position matriz 4 23) (position matriz 4 24))
               ...
               [(equal? contador 5)
                (f2i matriz (cons (list (position matriz 5 0) (position matriz 5 1) (position matriz 5 2) (position matriz 5 3) (position matriz 5 4)
                                        (position matriz 0 5) (position matriz 0 6) (position matriz 0 7) (position matriz 0 8) (position matriz 0 9)
                                        (position matriz 5 10) (position matriz 5 11) (position matriz 5 12) (position matriz 5 13) (position matriz 5 14)
                                        (position matriz 5 15) (position matriz 5 16) (position matriz 5 17) (position matriz 5 18) (position matriz 5 19)
                                        (position matriz 5 20) (position matriz 5 21) (position matriz 5 22) (position matriz 5 23) (position matriz 5 24))
